 ...
 * @property changedToAt Unix epoch time format, in milliseconds. If the value is `null`,
 * so the [name] is currently used by the player.
 */
@Serializable
 ...
 * @property id Player's uuid.
 * @property name Player's name.
 * @property properties List of the properties, in the documentation,
 * the list contains only a once element who is the texture property.
